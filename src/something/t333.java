...
import gamesAllTogether.MainClass.Board;

// intro to tictactoe game
	public static JFrame frameChoose;
	public static JPanel panelChoose;
	public static JButton threeByThreeTTT;
	public static JButton fourByFourTTT;
	public static JLabel instruChoose;

	public static void chooseTTT() {
		panelChoose = new JPanel();
		frameChoose = new JFrame();
		frameChoose.setSize(1000, 400);
		frameChoose.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frameChoose.add(panelChoose);

		panelChoose.setLayout(null);

		instruChoose = new JLabel("Which version of TicTacToe would you like to play?");
		instruChoose.setBounds(10, 10, 600, 25);
		panelChoose.add(instruChoose);

		fourByFourTTT = new JButton("4 x 4 TicTacToe Game");
		fourByFourTTT.setBounds(550, 50, 500, 35);
		fourByFourTTT.addActionListener(new MainClass());
		panelChoose.add(fourByFourTTT);

		threeByThreeTTT = new JButton("3 x 3 TicTacToe Game");
		threeByThreeTTT.setBounds(10, 50, 500, 35);
		threeByThreeTTT.addActionListener(new MainClass());
		panelChoose.add(threeByThreeTTT);
	...
	public static void threeByThreeTicTacToeGame() {
		...
		slider.addChangeListener(new MainClass());
		topPanel.add(oButton=new JButton("O Color"));
		topPanel.add(xButton=new JButton("X Color"));
		oButton.addActionListener(new MainClass());
		xButton.addActionListener(new MainClass());
	...
	private static class Board extends JPanel implements MouseListener {
		...
		public Board() {
			addMouseListener((MouseListener) new MainClass());
		}
